      ...
      <div className='container'>
        <div className='row'>
          <div className='about-col1'>
            <img src={Apic} alt='Hemika Amilineni' className='Apic' />
          </div>
...
<br/>I thrive in collaborative, agile environments and continuously seek opportunities to grow as a developer and problem solver. Whether it's through academic projects like fraud detection systems or personal projects like a Netflix-clone SPA, I'm always eager to innovate and learn.
            ...
            <div className='tab-contents' id='experience'>
              {activeTab === 'experience' && (
                <ul>
                       <li>
        <span>Software Engineer, Accenture  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Oct 2022 – Oct 2023</span>
      ...
      <li>
        ...
        <br />• Assisted undergraduate courses in JavaScript, Haskell, SQL, and Security through guided learning and lab sessions.
        <br />• Helped students strengthen problem-solving, debugging, and query optimization skills using real-world programming exercises.
        <br />• Simplified complex programming concepts into practical examples, encouraged collaborative learning, and provided feedback on projects to reinforce secure coding and database best practices
      </li>
      <br />
            ...
            <div className='tab-contents' id='education'>
              {activeTab === 'education' && (
                <ul>
                  ...
                  <p><strong>Relevant Coursework:</strong> Machine Learning, Mobile Security, Computer Vision, Embedded Machine Learning, Advanced Data Science.</p>
                </ul>
              )}
            </div>
          </div>
